...
3. **Credits** — monthly pools (and any purchased balance on file) **do not necessarily roll over** unless explicitly stated; clarify expiry if any.
...
- Checkout: `POST /api/billing/create-checkout-session` (subscription).
