...
- **Runs** `research_model_benchmarks.py` to fetch benchmark scores (SWE-bench, MATH/GSM8K, Vision Arena, Text-to-Image Arena, etc.) and add the model to the "Help me choose" dropdown when scores are available
