...
| 22 | Done | Backend 275 passed, 12 skipped. Frontend 709 passed. Added test_registry.py (8 tests), test_error_handling.py (8 tests). Removed MainPage.tsx IMPORTANT comment. Backend app loads OK. No # ==== in backend/app or frontend/src. CI has 5 workflows. Playwright e2e not run (port in use). |
