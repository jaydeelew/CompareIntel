...
export const HELP_ME_CHOOSE_CATEGORIES: HelpMeChooseCategory[] = [
  {
    ...
    models: [
      ...
      { modelId: 'openai/gpt-oss-120b', evidence: 'Avg. $0.11/1M tokens.' },
      { modelId: 'microsoft/phi-4', evidence: 'Avg. $0.10/1M tokens.' },
      { modelId: 'qwen/qwen3-30b-a3b-instruct-2507', evidence: 'Avg. $0.20/1M tokens.' },
      { modelId: 'deepseek/deepseek-v4-flash', evidence: 'Avg. $0.17/1M tokens.' },
      { modelId: 'mistralai/mistral-small-3.2-24b-instruct', evidence: 'Avg. $0.14/1M tokens.' },
      ...
      { modelId: 'google/gemma-3-27b-it', evidence: 'Avg. $0.12/1M tokens.' },
      ...
      { modelId: 'qwen/qwen-plus-2025-07-28', evidence: 'Avg. $0.52/1M tokens.' },
      { modelId: 'minimax/minimax-m2.5', evidence: 'Avg. $0.65/1M tokens.' },
      { modelId: 'qwen/qwen3-coder-flash', evidence: 'Avg. $0.58/1M tokens.' },
      { modelId: 'qwen/qwen3-next-80b-a3b-instruct', evidence: 'Avg. $0.60/1M tokens.' },
      { modelId: 'deepseek/deepseek-chat-v3.1', evidence: 'Avg. $0.50/1M tokens.' },
      { modelId: 'mistralai/codestral-2508', evidence: 'Avg. $0.60/1M tokens.' },
      ...
      { modelId: 'openai/gpt-5.6-luna', evidence: 'Avg. $0.70/1M tokens.' },
  ...
  },
  {
    ...
    categoryInfoTooltip: 'Ranked by Vision Arena (lmarena.ai), human preference votes on image+text prompts. Higher Arena Score = better at interpreting photos, diagrams, and screenshots. Required when you attach images to your prompt.',
    models: [
      ...
      { modelId: 'google/gemini-3.6-flash', evidence: 'Vision Arena (lmarena.ai): 1311.' },
      ...
      { modelId: 'google/gemini-3.1-flash-lite-preview', evidence: 'Vision Arena (lmarena.ai): 1243.' },
  ...
  },
  {
    ...
    models: [
      { modelId: 'anthropic/claude-fable-5', evidence: 'LegalBench (vals.ai): 88.56%.' },
      ...
      { modelId: 'openai/gpt-5.4', evidence: 'LegalBench (vals.ai): 86.04%.' },
