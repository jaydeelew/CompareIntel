...
export const HELP_ME_CHOOSE_CATEGORIES: HelpMeChooseCategory[] = [
  {
    ...
    models: [
      ...
      { modelId: 'xiaomi/mimo-v2-flash', evidence: 'Avg. $0.19/1M tokens.' },
      ...
      { modelId: 'google/gemma-4-31b-it', evidence: 'Avg. $0.26/1M tokens.' },
      ...
      { modelId: 'qwen/qwen3-coder-next', evidence: 'Avg. $0.43/1M tokens.' },
      { modelId: 'qwen/qwen3-next-80b-a3b-thinking', evidence: 'Avg. $0.44/1M tokens.' },
      { modelId: 'deepseek/deepseek-chat-v3.1', evidence: 'Avg. $0.45/1M tokens.' },
      { modelId: 'qwen/qwen-plus-2025-07-28', evidence: 'Avg. $0.52/1M tokens.' },
      { modelId: 'minimax/minimax-m2.5', evidence: 'Avg. $0.56/1M tokens.' },
      ...
      { modelId: 'qwen/qwen3-coder', evidence: 'Avg. $0.61/1M tokens.' },
