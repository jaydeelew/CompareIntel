...
export function exportToMarkdown(data: ComparisonExportData): string {
  ...
  // Footer
  md += `---\n\n`
  md += `*Exported from [CompareIntel](https://compareintel.com) - Compare AI & Image Models Side-by-Side*\n`
...
<body>
  ...
  // Footer
  html += `<div class="footer">Exported from <a href="https://compareintel.com">CompareIntel</a> — Compare AI & Image Models Side-by-Side</div>`
