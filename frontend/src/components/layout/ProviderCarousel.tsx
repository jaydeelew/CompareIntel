...
export function ProviderIcon({ provider }: { provider: string }) {
  ...
  switch (provider) {
    ...
    case 'Sourceful':
      // Riverflow wave icon (riverflow.ai/images/riverflow-logo-dark-icon.svg)
      return (
        <svg viewBox="0 0 35 28" className="provider-carousel-svg" aria-hidden>
          <path
            d="M22.8906 20.0417C22.0457 18.2736 24.131 17.0913 25.2651 16.1631C29.0173 13.0888 33.4437 7.02425 29.3856 2.35612C26.6345 -0.808471 21.3069 -0.596379 18.3331 2.11673C15.7547 4.46864 14.0607 7.57023 12.5769 10.6991C11.8631 12.2027 11.1888 13.723 10.4771 15.2287C9.79034 16.6797 9.06405 18.2484 7.76547 19.2479C7.71552 19.2857 7.66557 19.3235 7.61355 19.3592C6.16929 20.384 4.48363 19.6196 4.17355 17.8893C3.69491 15.2371 4.86446 12.3413 7.85911 8.77139C10.448 5.6803 13.4426 2.7299 16.7577 0H10.5645C8.46887 1.96133 6.52307 4.00876 4.75417 6.11918C2.33805 9.00028 -0.766896 13.4311 0.171664 18.6242C0.552499 20.7347 1.86149 22.5217 3.66785 23.4079C5.37432 24.2415 7.33885 24.1932 9.06197 23.2735C11.6924 21.8686 13.1159 19.1051 14.3708 16.5159C15.9191 13.3198 17.3134 10.004 19.3861 7.10405C20.3164 5.8021 21.9542 4.19775 23.6523 4.19775C25.0425 4.19775 26.3556 5.09232 26.6033 6.49717C26.8218 7.71093 26.52 8.93938 25.8686 9.96625C23.44 13.8028 16.1813 15.9027 18.3664 21.6691C18.5495 22.1521 18.7889 22.6141 19.074 23.0425C19.2758 23.3533 19.5047 23.6473 19.7503 23.9308H26.7448C23.4317 21.919 22.8906 20.0396 22.8906 20.0396V20.0417Z"
            fill={color}
          />
        </svg>
      )
    ...
    case 'Nvidia':
      // NVIDIA n-eye mark (Simple Icons / NVIDIA brand, viewBox 0 0 24 24)
      return (
        <svg viewBox="0 0 24 24" className="provider-carousel-svg" aria-hidden>
          <path
