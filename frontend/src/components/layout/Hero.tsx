          ...
          <div className="hero-capabilities-wrap">
            ...
            >
              <CapabilityTile
                ...
                backText="Compare natural language responses. Tap 'Try a comparison' and when the results come in, select the tab for each model to see their responses."
              ...
              <CapabilityTile
                ...
                backText="Compare code solutions. Tap 'Try a comparison' and when the results come in, select the tab for each model to see their code."
              ...
              <CapabilityTile
                ...
                backText="Compare formatted math results. Tap 'Try a comparison' and when the results come in, select the tab for each model to see their work."
              ...
              <CapabilityTile
                ...
                backText="Compare generated images. Tap 'Try a comparison' and when the results come in, select the tab for each model to see their images."
