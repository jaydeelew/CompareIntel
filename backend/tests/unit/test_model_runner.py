...
class TestConversationHistoryTruncation:
    ...
    def test_truncate_conversation_history_short(self):
        ...
        truncated, was_truncated, original_count = truncate_conversation_history(history, max_messages=20)
    ...
    def test_truncate_conversation_history_empty(self):
        ...
        truncated, was_truncated, original_count = truncate_conversation_history([], max_messages=20)
