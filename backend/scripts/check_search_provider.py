...
def check_search_provider():
    ...
    try:
        ...
        print(f"Active Search Provider: {active_provider if active_provider else 'None (not configured)'}")
        ...
        if active_provider:
            ...
            print("\nTo fix this:")
            print("1. Set up a search provider API key (e.g., BRAVE_SEARCH_API_KEY) in backend/.env")
